let btnEl = document.querySelectorAll(".btn-cart"); // Selecting all buttons with the class "btn-cart"
...
btnEl.forEach((btn) => { // Using forEach loop to add event listeners to all "Add to cart" buttons
